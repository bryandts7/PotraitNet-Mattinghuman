...
from utils import calcIOU, FocalLoss, loss_KL, AverageMeter, adjust_learning_rate, Logger
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', 
                        default='./config/config_easypotrait.yaml', 
                        type=str, help='the config path of the model')
    
    parser.add_argument('--workers', default=18, type=int, help='number of data loading workers')
